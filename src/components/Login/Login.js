        ...
        <section className="h-screen flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-16 items-center my-2 mx-5 md:mx-0 md:my-0">
            ...
            <div className="md:w-1/3 max-w-sm">
                ...
                <form onSubmit={handleSubmit(checkLogin)}>
                    <input
                        className="text-sm w-full px-4 py-2 border border-solid border-gray-300 rounded focus:outline-blue-700"
                        type="text"
                    ...
                    <input
                        className="text-sm w-full px-4 py-2 border border-solid border-gray-300 rounded mt-4 focus:outline-blue-700"
                        type="password"
